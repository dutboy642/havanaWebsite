...
const Layout = () => {
    ...
    return (
        ...
        <div className="min-h-screen">
            <Header />
            <div className="sticky top-0 bg-white z-40">
                <div className="flex items-center justify-between px-4 sm:px-6 lg:px-16 mx-4 sm:mx-8 lg:mx-16">
                    <div className="flex items-center space-x-4 sm:space-x-6 w-12 sm:w-16 md:w-20">
                        <button
                            type="button"
                    ...
                    <Link to="/" >
                        <img className="w-20 sm:w-24 lg:w-28 py-2 sm:py-4" src={logo} alt="Logo" />
                    </Link>
                    <div className="flex items-center space-x-4 sm:space-x-6 w-12 sm:w-16 md:w-20">
                        <UserIcon name="homepage" />
                        <CartIcon />
                    ...
                    <button
                        className="md:hidden text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 p-2 rounded-md"
