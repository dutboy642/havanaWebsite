...
const CustomerSupport: React.FC = () => {
    return (
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10">
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2">HỖ TRỢ KHÁCH HÀNG</h3>
            <div className='h-[4px] w-8 bg-white mb-1'></div>

            <ul>
                <li className='mb-2 text-sm sm:text-base md:text-lg hover:cursor-pointer hover:text-cyan-500'>
