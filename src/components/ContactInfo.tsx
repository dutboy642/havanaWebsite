...
const ContactInfo: React.FC = () => {
    return (
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10">
            <h3 className="mb-2 text-lg sm:text-xl md:text-2xl font-bold">HAVANA SHOP</h3>
            <div className="h-[4px] w-8 bg-white mb-1"></div>
            <p className="mb-1 cursor-pointer hover:text-cyan-500 text-sm sm:text-base md:text-lg">
                <i className="fa fa-map-marker me-2" aria-hidden="true"></i>
