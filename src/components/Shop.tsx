    ...
    return (
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10">
            ...
            <div className='flex flex-wrap gap-4 justify-start'>
                <img className='w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mb-1 rounded hover:opacity-70 hover:cursor-pointer hover:text-cyan-500' src={facebook} />
                <img className='w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mb-1 rounded hover:opacity-70 hover:cursor-pointer hover:text-cyan-500' src={ig} />
                <img className='w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mb-1 rounded hover:opacity-70 hover:cursor-pointer hover:text-cyan-500' src={email} />
            </div>
        </div>
